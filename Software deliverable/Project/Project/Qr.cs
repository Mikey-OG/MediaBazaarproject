...
namespace Project
{
    public partial class Qr : Form
    {
        ...
        {
            string code = "http://i433436.hera.fhict.nl/Attendance.php?Key=" + encry.Encrypt(DateTime.Now.ToString("dd-MM-yyyy") + Variables.User);
        ...
        {
            System.Diagnostics.Process.Start("http://i433436.hera.fhict.nl/Attendance.php?Key=" + encry.Encrypt(DateTime.Now.ToString("dd-MM-yyyy") + Variables.User));
