...
<body>
	...
	<form class="actionBar" method="post">
		...
		<div class="actionBar-date">
			<?php
				require_once ("class/LGC_ScheduleManagement.class.php");
				$lsm = new LGC_ScheduleManagement();
	...
	<div class="cards">
		...
		while ($countDay < 7) {
			...
			<div class='card'>
				<div class='card-date'>
					". $lsm->Date($countDay, $_SESSION['Date']) ."
				</div>
				<div class='card-schedule'>
					<div class='card-schedule-column'>
						...
						<div class='card-schedule-column-content'>
							". $lsm->ShiftEmployees($countDay, "Morning", $_SESSION['UserID']) ."
						</div>
					</div>
					<div class='card-schedule-column'>
						<div class='card-schedule-column-title'>
						...
						<div class='card-schedule-column-content'>
							". $lsm->ShiftEmployees($countDay, "Afternoon", $_SESSION['UserID']) ."
						</div>
					</div>
					<div class='card-schedule-column'>
						<div class='card-schedule-column-title'>
						...
						<div class='card-schedule-column-content'>
							". $lsm->ShiftEmployees($countDay, "Evening", $_SESSION['UserID']) ."
						</div>
					</div>	
				</div>
			</div>";
			...
			<div class='card'>
				...
				<div class='card-schedule'>
					<div class='card-schedule-column'>
						...
						<div class='card-schedule-column-content'>
							". $lsm->ShiftEmployee($countDay, "Morning", $_SESSION['UserID']) ."
						</div>
					</div>
					<div class='card-schedule-column'>
						<div class='card-schedule-column-title'>
						...
						<div class='card-schedule-column-content'>
							". $lsm->ShiftEmployee($countDay, "Afternoon", $_SESSION['UserID']) ."
						</div>
					</div>
					<div class='card-schedule-column'>
						<div class='card-schedule-column-title'>
						...
						<div class='card-schedule-column-content'>
							". $lsm->ShiftEmployee($countDay, "Evening", $_SESSION['UserID']) ."
						</div>
					</div>	
				</div>
			</div>";
